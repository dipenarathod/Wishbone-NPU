...
Package tensor_operations_dense Is
	...
	Function dense_requantize(
		product  								: signed(63 Downto 0);
		quantized_multiplier_right_shift	: unsigned(7 Downto 0)
	) return signed ;
	
	--Addign a Third part of requantization: clamp. Removing clamping from the the old function dense_requantize_clamp
	Function dense_clamp(
