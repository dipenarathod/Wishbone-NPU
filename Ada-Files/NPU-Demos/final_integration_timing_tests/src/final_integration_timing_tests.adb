...
procedure Final_Integration_Timing_Tests is
  ...
  --  Matches                  : Natural;
  Total_Samples            : constant Natural := 10;
  --  Accuracy                 : Float;
  ...
  Total_Words_Produced_Third_MaxPool : constant Natural :=
   Tensor_Words (Total_Bytes_Produced_Third_MaxPool, One_Dimensional => True);
  ...
  Total_Words_Produced_Fourth_MaxPool : constant Natural :=
   Tensor_Words (Total_Bytes_Produced_Fourth_MaxPool, One_Dimensional => True);
  ...
  Total_Words_Produced_Fifth_MaxPool : constant Natural :=
   Tensor_Words (Total_Bytes_Produced_Fifth_MaxPool, One_Dimensional => True);
...
begin
  ...
  Write_Words_In_B (layer_28_dense_1_Weights_Words, Weights_Base_Second_Dense);
  ...
  for i in 0 .. Total_Samples - 1 loop
    Total_Cycles := 0;
    ...
    Apply_Conv2D_All_Words
     (N                                => Input_Len_First_Conv,
      ...
      Quantized_Multiplier             => layer_3_conv2d_Quantized_Multiplier,
    ...
    Apply_Conv2D_All_Words
     (N                                => Input_Len_Third_Conv,
      Input_Channels                   => Number_Of_Input_Channels_Third_Conv,
      Filters                          => Number_Of_Output_Channels_Third_Conv,
    ...
    Apply_Dense_All_Words
     (Inputs                           => Inputs_First_Dense,
      ...
      Quantized_Multiplier             => layer_24_dense_Quantized_Multiplier,
      Quantized_Multiplier_Right_Shift =>
...
end Final_Integration_Timing_Tests;
